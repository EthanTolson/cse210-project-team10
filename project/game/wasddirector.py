...
class WASDDirector(View):
    def __init__(self):
        ...
        self.helpscreen = load_texture(f"{RESOURCE_PATH}Helpmenuvideogamewasd.png")        
    ...
    def on_update(self, delta_time: float):
        ...
        if not self.pauseBool:
            ...
            if len(self.enemySprites) == 0 and self.level < 1003:
                ...
                if self.level > 1001:
                    WASDController.keyevent(self, ESCAPE)
    ...
    def on_key_press(self, symbol: int, modifiers: int):
        ...
        """
        WASDController.keyevent(self, symbol)


    def on_key_release(self, symbol: int, modifiers: int):
        WASDController.keyremoveevent(self, symbol)
    ...
    def on_mouse_press(self, x: float, y: float, button: int, modifiers: int):
        ...
        """
        WASDController.mouseevent(self, x, y, button)  
