...
class EndScreen(arcade.View):
    ...
    def on_update(self, delta_time: float):
        if self.director.player.player_hp <= 0 and self.director.backgroundmusic.getPlayingID() != 4:
            self.director.backgroundmusic.play(4)
        elif self.director.player.player_hp > 0 and self.director.backgroundmusic.getPlayingID() != 3:
