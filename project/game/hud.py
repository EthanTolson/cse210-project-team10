...
class drawHUD():
    def drawHUD(director = None):
        ...
        draw_lrwh_rectangle_textured(x + 50, playery + 10, 75, 75, load_texture(f"{RESOURCE_PATH}whudPNG.png"), alpha = w)
        draw_lrwh_rectangle_textured(x + 50, playery - 85, 75, 75, load_texture(f"{RESOURCE_PATH}ehudPNG.png"), alpha = e)
        ...
        draw_lrwh_rectangle_textured(x + 50, playery - 180, 75, 75, load_texture(f"{RESOURCE_PATH}rhudPNG.png"), alpha = r)
